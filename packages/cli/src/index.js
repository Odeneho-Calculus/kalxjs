...
program
  .name('kalxjs')
  .description('kalxjs CLI - A tool for kalxjs framework development')
  .version(version);
...
program
  .command('generate:component <component-name>')
  .alias('g:c')
  .description('Generate a new component')
  .option('--script', 'Add script section with methods')
...
program
  ...
  .alias('g:v')
  .description('Generate a new view (page component)')
  .option('--script', 'Add script section with methods')
  .action(createView);
