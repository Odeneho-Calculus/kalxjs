            ...
            try {
                ...
                try {
                    if (typeof componentOptions === 'string') {
                        ...
                        // Check if the component has props with default values
                        if (componentOptions.props) {
                            console.log('Component has props definition:', componentOptions.props);

                            // Initialize props with default values
                            const initialProps = {};

                            // Process props definition
                            if (typeof componentOptions.props === 'object') {
                                for (const propName in componentOptions.props) {
                                    const propDef = componentOptions.props[propName];

                                    // If the prop definition is an object with a default value
                                    if (typeof propDef === 'object' && 'default' in propDef) {
                                        // If default is a function, call it, otherwise use the value directly
                                        initialProps[propName] = typeof propDef.default === 'function'
                                            ? propDef.default()
                                            : propDef.default;

                                        console.log(`Initialized prop ${propName} with default value:`, initialProps[propName]);
                                    }
                                }
                            }

                            // Create the component with initial props
                            instance = createComponent(componentOptions, initialProps);
                        } else {
