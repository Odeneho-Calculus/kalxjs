...
name: 'App',
  ...
  render() {
      return h('div', { class: "app", }, ["\n    <header class=\"app-header\">\n      <div class=\"logo-container\">\n        ", h('img', { src: "./assets/logo.svg", alt: "KalxJS Logo", class: "logo", }, []), h('h1', { class: "app-title", }, ["test-app", ]), ]);
...
(function() {
  if (typeof document !== 'undefined') {
    ...
    if (!document.getElementById('klx-style-3eg05zvx')) {
      ...
      style.setAttribute('id', 'klx-style-3eg05zvx');
